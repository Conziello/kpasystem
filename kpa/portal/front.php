  ...
  <div class="container">
    <div class="vd_content vd_info-parent clearfix">
      <div class="word-header">
        <h1 class="font-semibold text-center vd_white"><strong>SUPER AWESOME</strong> PROPERTY SOFTWARE</h1>
      </div>
      ...
      <div class="row">
        <div class="col-md-4 mgbt-sm-10 mgbt-md-0">
          <div class="highlight-word appear">
            ...
            <div class="font-md deploy-word" style="font-size:18px">Deploy in less than 24 hours!!!</div>
          </div>
        </div>
        <div class="col-md-8">
      ...
      <div class="row mgtp-20">
        ...
        <div class="col-md-4 mgbt-sm-20">
          <div class="text-center clearfix feature-3">
            ...
            <h2 class="font-semibold mgbt-xs-15">Efficient</h2>
            <p>The system has been designed to easen your day to day business, hence saving time and Money. </p>
          </div>
        </div>
      </div>
    </div>
...
we got your back on all things software.</p>
      ...
      <div class="row">
        <div class="col-md-12 text-center mgbt-xs-20">
          ...
          <h2 class="font-semibold"> Property Portal Screen Shots </h2><br/>
        </div>
            ...
            <div class="vd_carousel">
              <div class="vd_carousel-column">
                <div class="content-list  content-large">
                  <div class="menu-icon"> <img alt="example image" class="img-circle" src="img/avatar/1.jpg" /> </div>
                  <div class="menu-text"> <br/>
                    <br/>
                    <h4 class="vd_black font-semibold mgbt-xs-0"><strong>Angela Wanjiru</strong></h4>
                    <p class="vd_black font-semibold">Director, Fractal Agencies</p>
                  </div>
                </div>
              ...
              <div class="vd_carousel-column">
                <div class="content-list  content-large">
                  <div class="menu-icon"> <img alt="example image" class="img-circle" src="img/avatar/2.jpg" /> </div>
                  <div class="menu-text"> <br/>
                    <br/>
              ...
              <div class="vd_carousel-column">
                <div class="content-list  content-large">
                  <div class="menu-icon"> <img alt="example image" class="img-circle" src="img/avatar/3.jpg" /> </div>
                  <div class="menu-text"> <br/>
                    <br/>
              ...
              <div class="vd_carousel-column">
                <div class="content-list  content-large">
                  <div class="menu-icon"> <img alt="example image" class="img-circle" src="img/avatar/4.jpg" /> </div>
                  <div class="menu-text"> <br/>
                    <br/>
