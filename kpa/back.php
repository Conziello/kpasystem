...
switch($id){
							...
							case 1:
							$name=$_GET['name'];
							$email='info@propertyportal.biz';
							$phone=$_GET['phone'];
							$message='Enquiry on Property Portal-Email from '.$name.'-Phone no:'.$phone;
							

							$to='info@propertyportal.biz';
							$subject = 'Enquiry on Property Portal';
							$reply=$email;
							
							$headers='';
							$headers .= "Reply-To: ".$name." <".$email.">\r\n";
							$headers .= "Return-Path: ".$name." <info@propertyportal.biz>\r\n";
							...
							$headers .= "Reply-To: ".$name." <".$email.">\r\n";
							$headers .= "Return-Path: ".$name." <info@propertyportal.biz>\r\n";
							$headers .= "From: ".$name." <info@propertyportal.biz>\r\n";
							$headers .= "MIME-Version: 1.0\r\n";
							$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
