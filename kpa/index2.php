            ...
            <div class="vd_login-page">
              ...
              <div class="panel widget">
                <div class="panel-body" style="border:1px solid #ddd">
                    <h4 class="text-center font-semibold vd_grey">THE PROPERTY PORTAL<BR/></h4>
                  <div class="login-icon entypo-icon" id="message"> <i class="icon-key"></i> </div>
                  <form class="form-horizontal" id="login-form" action="#" role="form">
                    <div class="form-group  mgbt-xs-20">
                      <div class="col-md-12">
                         <div class="label-wrapper sr-only"  style="display:none">
                          <label class="control-label" for="username">Property</label>
                        </div>
                        <div class="vd_input-wrapper" id="email-input-wrapper"  style="display:none"></span>
                             <select id="property" class="required">
                              <option value="qkodi2">SELECT PROPERTY</option>
                              </select>
                        </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-12 text-center mgbt-xs-5">
                        <button class="btn vd_bg-green vd_white width-100" type="button" id="login-submit" onclick="login()">Login</button>
...
function login(){
  ...
  var property=$('#property').val();
    if(property==''){
    swal("Error", "Select Property!", "error");
    }
  else if(username==''){
